...
\author{\addition{Bogdan Gavrilovic}}
...
%% TODO: say the below nicely

%% However, we point out that many experts in workflows and workflow engines do not yet appreciate the importance of standards, in contrast to the knowledge representation field, where data standards are commonly adopted and have become expected for funded projects.
...
Real world usage at scale: routinely CWL users and vendors report that they analyze 5000 whole genome sequences (typically on the order of 100 Gigabytes each) in a single workflow execution; one customer of a commercial vendor reported a successful run of a workflow that contained an 8,000-wide step; the entire workflow had 25,000 container executions.
}
...
To conclude: this is a call for others to embrace workflow thinking and join the CWL community. \todorthree{5}\todorthree{8}\addition{With the CWL standards, the methods are included and ready to (re)use}!
...
\deletion{\contributor{https://orcid.org/0000-0003-1550-1716}{Bogdan Gavrilovic}{Conceptualization, Software, Validation, Bug Reports, Blogposts, Maintenance, Tools, Answering Questions, Reviewed Contributions, User Testing},}
...
\addition{\contributor{https://orcid.org/0000-0003-1550-1716}{Bogdan Gavrilovic}{Conceptualization, Software, Validation, Bug Reports, Blogposts, Maintenance, Tools, Answering Questions, Reviewed Contributions, User Testing},}
