...
Real world usage at scale: routinely CWL users and vendors report that they analyze 5000 whole genome sequences (typically on the order of 100 Gigabytes each) in a single workflow execution; one customer of a commercial vendor reported a successful run of a workflow that contained an 8,000-wide step; the entire workflow had 25,000 container executions\footnote{\url{https://docs.google.com/document/d/1tZWwgBAromWOj6hz12J_QLMpvsJV-3vnCH8ttm_eDOE/edit#bookmark=id.gg2bb2h9n4pz}}.
